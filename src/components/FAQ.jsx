const FAQSection = () => {
    const faqs = [
      ...
      },
      {
        ...
        answer: "Yes, you can select from vegetarian, non-vegetarian, and dietary-specific meal options.",
      },
      {
        question: "What if I have food allergies?",
        answer: "Please inform the management in advance so we can accommodate your needs.",
      },
    ];
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              ...
              >
                <h3 className="text-2xl font-semibold text-indigo-600">{faq.question}</h3>
